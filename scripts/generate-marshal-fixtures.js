...
const FIXTURES = [
    ...
    {pyc: 'test/bytecode_3.9/py36_async_generator.pyc', outDir: `${ROOT}/bytecode_3.9`},
    {pyc: 'test/bytecode_3.9/py36_async_comprehensions.pyc', outDir: `${ROOT}/bytecode_3.9`},
    {pyc: 'test/bytecode_3.9/py36_fstrings_nested.pyc', outDir: `${ROOT}/bytecode_3.9`},
    {pyc: 'test/bytecode_3.9/py39_str_methods.pyc', outDir: `${ROOT}/bytecode_3.9`},
