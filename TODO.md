...
- Tests/CI: broaden matrix (1.x, 2.x, 3.4, 3.6, 3.8, 3.10, 3.11–3.14) with f-string/walrus/match/EG coverage + diff-normalization harness; integrate matrix runner into full suite (currently smoke on py311_exception_groups).
