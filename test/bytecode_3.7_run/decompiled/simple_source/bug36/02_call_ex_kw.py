...
assert (2, {'test': "4"})("test2" = "a") == {"c": "2", "test2": "a", "param1": 2, "test": "B"}
...
elif not (2, "3")("test2" = "a") == {"c": 2, "test2": "a", "param1": 2, "test": "B"}:
    raise AssertionError

elif not (False, "3")("test2" = "a") == {"c": False, "test2": "a", "param1": 2, "test": "B"}:
    raise AssertionError

elif not (2)("test2" = "A") == {"c": 2, "test2": "A", "param1": 2, "test": "A"}:
    raise AssertionError
elif not (str(2) + str(1))("test2" = "a") == {"c": "21", "test2": "a", "param1": 2, "test": "A"}:
    raise AssertionError
    ...
    elif not [(2), c]() == {"c": 2, "param1": 2, "test": 2}:
        raise AssertionError
