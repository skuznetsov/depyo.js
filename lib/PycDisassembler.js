    ...
    static Disassemble (reader, obj, parentPrefix) {
        ...
        while (code.HasInstructionsToProcess) {
            try {
                ...
                result += "\t" + [pad(`O:${opCode.Offset}, L:${obj.LineNoTab[opCode.Offset]}`, 13), pad(opCode.InstructionName, 19), pad(opCode.HasArgument ? opCode.Argument : "", 4), "  ", argValue != "" ?  "// Value: " + argValue : ""].join(" ") + "\n";
            } catch (ex) {
