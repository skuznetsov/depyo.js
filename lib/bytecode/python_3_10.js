...
const opcodes = [
    ...
    [34, new OpCode(OpCodes.COPY_DICT_WITHOUT_KEYS, "COPY_DICT_WITHOUT_KEYS")],
    ...
    [99, new OpCode(OpCodes.ROT_N_A, "ROT_N", {HasArgument: true})],
    ...
    [121, new OpCode(OpCodes.JUMP_IF_NOT_EXC_MATCH_A, "JUMP_IF_NOT_EXC_MATCH", {HasArgument: true, HasJumpAbsolute: true})],
    ...
    [129, new OpCode(OpCodes.GEN_START_A, "GEN_START", {HasArgument: true})],
...
module.exports = Python3_10_OpCodes;
