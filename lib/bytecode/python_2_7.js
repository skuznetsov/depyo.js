...
const opcodes = [
    ...
    [94, new OpCode(OpCodes.LIST_APPEND_A, "LIST_APPEND", {HasArgument: true})],
    ...
    [145, new OpCode(OpCodes.EXTENDED_ARG_A, "EXTENDED_ARG", {HasArgument: true})],
...
module.exports = Python2_7_OpCodes;
