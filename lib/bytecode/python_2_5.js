...
const opcodes = [
    ...
    [18, new OpCode(OpCodes.LIST_APPEND, "LIST_APPEND")],
    ...
    [81, new OpCode(OpCodes.BREAK_LOOP, "BREAK_LOOP")],
    [82, new OpCode(OpCodes.WITH_CLEANUP, "WITH_CLEANUP")],
...
module.exports = Python2_5_OpCodes;
