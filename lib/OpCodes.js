...
/* Instrumented opcodes */
    ...
    // Aliases / placeholders for 3.13+ opcodes to reuse existing handlers until fully implemented
    static POP_ITER = OpCodes.POP_TOP;
    static WITH_EXCEPT_START_A = OpCodes.WITH_EXCEPT_START;
    static END_ASYNC_FOR_A = OpCodes.END_ASYNC_FOR;
    static POP_BLOCK_A = OpCodes.POP_BLOCK;
    static CALL_FUNCTION_EX = OpCodes.CALL_FUNCTION_EX_A;
    static CALL_KW_A = OpCodes.CALL_A;
    static CONVERT_VALUE_A = OpCodes.NOP;
    static JUMP_A = OpCodes.JUMP_FORWARD_A;
    static JUMP_NO_INTERRUPT_A = OpCodes.JUMP_FORWARD_A;
    static LOAD_COMMON_CONSTANT_A = OpCodes.LOAD_CONST_A;
    static LOAD_FAST_BORROW_LOAD_FAST_BORROW_A = OpCodes.LOAD_FAST_LOAD_FAST_A;
    static LOAD_SPECIAL_A = OpCodes.LOAD_NAME_A;
    static SETUP_CLEANUP_A = OpCodes.SETUP_FINALLY_A;
    static STORE_FAST_MAYBE_NULL_A = OpCodes.STORE_FAST_A;
    static STORE_FAST_STORE_FAST_A = OpCodes.STORE_FAST_A;
    static ANNOTATIONS_PLACEHOLDER_A = OpCodes.NOP;
    static BUILD_INTERPOLATION_A = OpCodes.BUILD_STRING_A;
    static ENTER_EXECUTOR_A = OpCodes.NOP;
    static LOAD_SUPER_METHOD_A = OpCodes.LOAD_ATTR_A;
    static LOAD_ZERO_SUPER_ATTR_A = OpCodes.LOAD_ATTR_A;
    static LOAD_ZERO_SUPER_METHOD_A = OpCodes.LOAD_ATTR_A;
