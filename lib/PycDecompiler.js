            ...
            try {                
                ...
                switch (code.Current.OpCodeID)
                {
                    ...
                    case OpCodes.INSTRUMENTED_JUMP_FORWARD_A:
                        ...
                        {
                            let node = new AST.ASTName (code.Current.FreeName);
                            node.line = code.Current.LineNo;
                            DataStack.push(node);
                        }
                        break;
                        ...
                        {
                            let node = new AST.ASTName (code.Current.Name);
                            node.line = code.Current.LineNo;
                            DataStack.push(node);
                        }
                        break;
                        ...
                        {
                            if (!(DataStack.top() instanceof AST.ASTComprehension) && [OpCodes.JUMP_ABSOLUTE_A, OpCodes.JUMP_FORWARD_A, OpCodes.POP_JUMP_IF_FALSE_A].includes(code.Prev?.OpCodeID)) {
                                if (curBlock.blockType == AST.ASTBlock.BlockType.Except) {
                                    ...
                                    if ([OpCodes.JUMP_ABSOLUTE_A, OpCodes.JUMP_FORWARD_A].includes(code.Prev.OpCodeID)) {
                                        ...
                                        if (code.Next?.OpCodeID == OpCodes.STORE_NAME_A && code.Next?.Next?.OpCodeID == OpCodes.POP_TOP) {
