...
class PycDecompiler {
    ...
    static Decompile (obj) {
        ...
        if (funcBody.list.length == 0) {
            funcBody.list.push(new AST.ASTKeyword(null, AST.ASTKeyword.Word.Pass));
        }
                ...
                switch (code.Current.OpCodeID)
                {
                    ...
                    case OpCodes.INSTRUMENTED_FOR_ITER_A:
                    {
                        ...
                        if (obj.Reader.versionCompare(3, 8) >= 0) {
                            ...
                            if (DataStack.top() instanceof AST.ASTList && DataStack.top().values.length == 0) {
                        ...
                        let forblk = new AST.ASTIterBlock(null, AST.ASTBlock.BlockType.For, start, end, iter);
                        forblk.line = line;
                    ...
                    case OpCodes.INSTRUMENTED_POP_JUMP_IF_TRUE_A:
                    {
                        ...
                        } else if (code.Current.OpCodeID == OpCodes.JUMP_IF_FALSE_OR_POP_A || code.Current.OpCodeID == OpCodes.JUMP_IF_TRUE_OR_POP_A) {
                        ...
                        if (cond instanceof AST.ASTCompare
                            ...
                            ifblk = new AST.ASTCondBlock(null, top.blockType, top.start, offs, newcond, neg);
