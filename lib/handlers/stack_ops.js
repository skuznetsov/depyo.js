...
function handleDupTop() {
    // Save potential match subject: if previous opcode was LOAD_FAST/LOAD_NAME,
    // this might be the start of a match statement. Save TOS for later use.
    ...
    if (prevOpCode == this.OpCodes.LOAD_FAST_A ||
        ...
        if (global.g_cliArgs?.debug) {
            console.log(`[DUP_TOP] Saved potential match subject: ${this.potentialMatchSubject?.constructor.name}`);
        }
    }
