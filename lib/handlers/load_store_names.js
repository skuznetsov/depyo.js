...
function handleLoadConstA() {
    ...
    if (global.g_cliArgs?.debug && this.code.Current.Offset < 20) {
        console.log(`[LOAD_CONST] offset=${this.code.Current.Offset}, arg=${this.code.Current.Argument}, obj=${constantObject.object?.ClassName || 'null'}`);
    }
