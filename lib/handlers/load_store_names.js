...
function handleLoadSpecialA() {
    // Python 3.14 LOAD_SPECIAL (e.g., super attribute access); treat as name load.
    handleLoadNameA.call(this);
}
...
function handleStoreFastStoreFastA() {
    ...
    const valueNode = this.dataStack.pop() || new AST.ASTNone();
    this.curBlock.append(new AST.ASTStore(valueNode, new AST.ASTName(name1)));
    this.curBlock.append(new AST.ASTStore(valueNode, new AST.ASTName(name2)));
}
