class PythonObject {
    ...
    get length() {
        if (["Py_List", "Py_Tuple", "Py_Set", "Py_FrozenSet", "Py_VeryLong"].includes(this.ClassName)) {
    ...
    toString()
    {
        if (["Py_Int", "Py_Float", "Py_Long", "Py_Long64", "Py_Unicode", "Py_Interned"].includes(this.ClassName)) {
